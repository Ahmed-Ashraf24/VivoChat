...
fun MyMessageComponent(modifier: Modifier = Modifier,message:String) {
    ...
    Surface(modifier=Modifier.clickable{
        isVisible=!isVisible
    },shape = RoundedCornerShape(topStart = 15.dp, bottomStart = 15.dp, topEnd = 15.dp), color = onlineColor) {
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.Center) {
            Text(message, fontFamily = Poppins, color = Color.White, modifier = Modifier.padding(20.dp))
        }
    }
