...
import com.example.vivochat.data.dataSource.firebase_remote_datasource.firebase_utility.FirebaseIstance.firebaseAuth
...
fun NavScreen(
    ...
    darkModeViewModel: DarkModeViewModel
        ...
        Scaffold(
            ...
            HorizontalPager(state = state, modifier = Modifier.padding(paddingValues)) { pageIndex ->
                ...
                when (pageIndex) {
                    ...
                    1 -> StoryScreen()
                    2 -> SettingsScreen(darkModeViewModel=darkModeViewModel)
                }
